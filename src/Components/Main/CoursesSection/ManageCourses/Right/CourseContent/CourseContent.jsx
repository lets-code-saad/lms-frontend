...
const CourseContent = () => {
  ...
  // getting lessons from the slice
  const { stateLessons, lessonLoading } = useSelector(
  ...
  const handleSave = (e) => {
    if (
      !currentLesson.lessonTitle.trim() ||
      !currentLesson.lessonDescription.trim() ||
    ...
    if (currLessonIndex !== null) {
      ...
      // adding new lesson
      updatedLesson.push(currentLesson);
    }
